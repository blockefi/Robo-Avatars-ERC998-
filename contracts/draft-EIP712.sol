...
abstract contract EIP712 {
    ...
    function check() public view returns(bytes32, bytes32, bytes32, bytes32,uint,address){
        return(_TYPE_HASH, _HASHED_NAME, _HASHED_VERSION, _CACHED_DOMAIN_SEPARATOR,block.chainid,address(this));
    }
